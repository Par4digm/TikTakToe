...
def ChooseSide():
    ...
    global enemy_symbol
    player_symbol = str(input('Enter your team (X/O): '))
...
def PlayerPlay(r1, r2, r3, player_symbol):
    ...
    while PossiblePlay == False:
        ...
        colomn_play = int(input('Choose your colomn: ')) - 1

        if row_play == str(1):
            if (r1[colomn_play] == "_"):
                row_1[colomn_play] = player_symbol
                #pdb.set_trace()
                PossiblePlay = True 
            else:
                PossiblePlay = False
            ...
            if (r2[colomn_play] == "_"):
                row_2[colomn_play] = player_symbol
                PossiblePlay = True 
            else:
                PossiblePlay = False
                print("") 
            ...
            if (r3[colomn_play] == "_"):
                row_3[colomn_play] = player_symbol
                PossiblePlay = True 
            else:
                PossiblePlay = False
                print("") 
